...
var $;
(function ($) {
    class $tw_choo extends $mol_page {
        title() {
        ...
        Speed() {
            const obj = new this.$.$mol_number();
            obj.value = (next) => this.speed(next);
        ...
        Penetration() {
            const obj = new this.$.$mol_number();
            obj.value = (next) => this.penetration(next);
            return obj;
        }
        Penetration_info() {
            const obj = new this.$.$mol_labeler();
        ...
        Crit_chance() {
            const obj = new this.$.$mol_number();
            obj.value = (next) => this.crit_chance(next);
            return obj;
        }
        Crit_change_info() {
            const obj = new this.$.$mol_labeler();
        ...
        Crit_damage() {
            const obj = new this.$.$mol_number();
            obj.value = (next) => this.crit_damage(next);
            return obj;
        }
        Crit_damage_info() {
            const obj = new this.$.$mol_labeler();
    ...
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "damage", null);
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "Damage", null);
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "Damage_info", null);
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "speed", null);
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "Speed", null);
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "Speed_info", null);
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "penetration", null);
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "Penetration", null);
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "Penetration_info", null);
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "crit_chance", null);
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "Crit_chance", null);
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "Crit_change_info", null);
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "crit_damage", null);
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "Crit_damage", null);
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "Crit_damage_info", null);
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "DPS", null);
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "Conclusion", null);
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "GitHub", null);
    __decorate([
        $mol_mem
    ], $tw_choo.prototype, "Game", null);
    $.$tw_choo = $tw_choo;
})($ || ($ = {}));
//tw/choo/-view.tree/choo.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
//tw/choo/choo.view.ts
;
"use strict";
var $;
(function ($) {
    $mol_style_attach("tw/choo/choo.view.css", "");
})($ || ($ = {}));
//tw/choo/-css/choo.view.css.ts
;
"use strict";
var $;
(function ($_1) {
